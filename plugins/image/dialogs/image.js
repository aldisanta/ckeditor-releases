				...
				elements: [{
					...
					children: [{
						...
						children: [{
							...
							id: 'btnBrowseThumb',
							align: 'center',
							html: '<input type="button" style="background-image:url(/images/thumbnail_view.png);width:20px;height:17px;display:inline-block;margin-top:15px;float:right;cursor:pointer;"/>',
							onClick: function() {
								popup('/scripts/orch-ckeditor/orch-custom_plugins_server/image/imageLib_list.asp?sender=7&iType=1&sObj=txtUrl', 700, 350);
							},
							...
							id: 'btnBrowse',
							align: 'center',
							html: '<input type="button" value="&nbsp;... " style="background-color:#ffffff;border:solid 1px #000000;width:20px;height:17px;display:inline-block;margin-top:16px;float:right;cursor:pointer;text-align:justify;">',
							onClick: function() {
								popup('/scripts/orch-ckeditor/orch-custom_plugins_server/image/imageLib_list.asp?sender=7&iType=2&sObj=txtUrl', 700, 350);
							},
							filebrowser: 'info:txtUrl'
						}, {
							type: "button",
